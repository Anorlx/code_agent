...
def get_tool_registry(workspace_root: Path | None = None) -> dict[str, dict[str, Any]]:
    ...
    tools = {
        ...
        "search_user_memory": {
            "spec": search_user_memory_spec(),
            "run": search_user_memory,
            "category": "记忆",
            "responsibility": "按需检索个人长期记忆 Cards 和带上下文的历史证据",
            "parallel_safe": True,
            "side_effectful": False,
            "accepts_runtime_context": True,
            "exposure": "lazy",
        ...
        "list_memory_candidates": {
            "spec": list_memory_candidates_spec(),
            "run": list_memory_candidates,
            "category": "记忆",
            "responsibility": "查看需要确认的候选记忆",
            "parallel_safe": True,
            "side_effectful": False,
            "accepts_runtime_context": True,
            "exposure": "lazy",
        ...
        "confirm_memory_candidate": {
            "spec": confirm_memory_candidate_spec(),
            "run": confirm_memory_candidate,
            "category": "记忆",
            "responsibility": "确认或拒绝候选记忆并写入版本化 Card",
            "parallel_safe": False,
            "requires_review": True,
            "side_effectful": True,
            "accepts_runtime_context": True,
